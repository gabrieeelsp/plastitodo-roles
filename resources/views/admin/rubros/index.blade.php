        ...
        <div class="col-12">
          ...
          <div class="card-header table-title">
              <div class=" d-flex justify-content-between align-items-center">
                <h3 class="card-title" >Gestión <b>RUBROS</b></h3>
                <a href="{{ route('rubros.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Nuevo</a>
              </div>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-striped table-hover border-top">
                ...
                <tbody>
                  <tr v-for="rubro in items">
                    <td>@{{ rubro.id }}</td>
                    <td>@{{ rubro.name }}</td>
                    <td width="10px">
                      <div class="d-flex justify-content-around">
                        <a :href="'/admin/rubros/' + rubro.id + '/edit'" class="text-warning"><i class="fas fa-edit"></i></a>
  ...
  new Vue({
    ...
    methods: {
        getItems: function(page){
            ...
            var urlItems = 'rubros/list?page=' + page + '&searchText=' + this.searchText + '&cantidad=' + this.cantidad_entradas;

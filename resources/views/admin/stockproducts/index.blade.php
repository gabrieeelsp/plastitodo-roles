        ...
        <div class="col-12">
          ...
          <div class="card-header table-title">
              <div class=" d-flex justify-content-between align-items-center">
                <h3 class="card-title" >Gestión <b>PRODUCTOS STOCK</b></h3>
                <a href="{{ route('stockproducts.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Nuevo</a>
              </div>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-striped table-hover border-top">
                ...
                <tbody>
                  <tr v-for="stockproduct in items">
                    <td>@{{ stockproduct.id }}</td>
                    <td>@{{ stockproduct.name }}</td>
                    <td width="10px"> 
                      <span v-show="stockproduct.web_enable" class="badge bg-success">enable</span>
                      <span v-show="!stockproduct.web_enable" class="badge bg-red">disable</span>
                    </td>
                    <td width="10px"> 
                      <span v-show="stockproduct.enable" class="badge bg-success">enable</span>
                      <span v-show="!stockproduct.enable" class="badge bg-red">disable</span>
                    </td>
                    <td width="10px">
                      <div class="d-flex justify-content-around">
                        <a :href="'/admin/stockproducts/' + stockproduct.id + '/edit'" class="text-warning"><i class="fas fa-edit"></i></a>
                        
                        <a :href="'/admin/stockproducts/' + stockproduct.id + '/saleproducts'" class="text-success  "><i class="fas fa-align-justify"></i></a>
    ...
    methods: {
        getItems: function(page){
          ...
          if(this.only_enabled){
            ...
            var urlItems = 'stockproducts/list?page=' + page + '&searchText=' + this.searchText + '&cantidad=' + this.cantidad_entradas + '&only_enabled=' + only_enabled;
